package com.example.i322233.whereareyou;
...
import com.example.i322233.whereareyou.service.GpsService;
import com.example.i322233.whereareyou.util.UtilTool;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!UtilTool.isGpsEnabled((LocationManager) getSystemService(Context.LOCATION_SERVICE))){
            Toast.makeText(this, "GPS当前已禁用，请在您的系统设置中启动。", Toast.LENGTH_LONG).show();
        ...
        filter.addAction("com.example.i322233.whereareyou.service.GpsService");
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(lon!=null&&!"".equals(lon)&&lat!=null&&!"".equals(lat)){
                ...
                // TODO: 3/18/2016  发送消息给服务器,用webview的形式
